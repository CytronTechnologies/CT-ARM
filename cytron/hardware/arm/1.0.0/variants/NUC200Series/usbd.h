...
/** @addtogroup NUC200_USBD_Driver USBD Driver
  @{
*/

/** @addtogroup NUC200_USBD_EXPORTED_STRUCTS USBD Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC200_USBD_EXPORTED_STRUCTS */



/** @addtogroup NUC200_USBD_EXPORTED_CONSTANTS USBD Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_USBD_EXPORTED_CONSTANTS */



/** @addtogroup NUC200_USBD_EXPORTED_FUNCTIONS USBD Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_USBD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_USBD_Driver */
