 ...
 * @brief    NUC200 series Smartcard (SC) driver header file
 *
 * @note
...
/** @addtogroup NUC200_SC_Driver SC Driver
  @{
*/

/** @addtogroup NUC200_SC_EXPORTED_CONSTANTS SC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_SC_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_SC_EXPORTED_FUNCTIONS SC Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_SC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_SC_Driver */
