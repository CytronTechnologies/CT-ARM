 ...
 * @brief    NUC200 series WDT driver header file
 *
 * @note
...
/** @addtogroup NUC200_WDT_Driver WDT Driver
  @{
*/

/** @addtogroup NUC200_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC200_WDT_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_WDT_EXPORTED_FUNCTIONS WDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_WDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_WDT_Driver */
