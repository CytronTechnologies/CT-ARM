 ...
 * $Revision: 8 $
 * $Date: 14/05/12 2:35p $
 * @brief    NUC200 series RTC driver header file
 *
 * @note
...
/** @addtogroup NUC200_RTC_Driver RTC Driver
  @{
*/

/** @addtogroup NUC200_RTC_EXPORTED_CONSTANTS RTC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_RTC_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_RTC_EXPORTED_STRUCTS RTC Exported Structs
  @{
*/
/**
...
/*@}*/ /* end of group NUC200_RTC_EXPORTED_STRUCTS */


/** @addtogroup NUC200_RTC_EXPORTED_FUNCTIONS RTC Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_RTC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_RTC_Driver */
