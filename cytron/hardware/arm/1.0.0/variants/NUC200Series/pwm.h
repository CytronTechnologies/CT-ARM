 ...
 * @version  V3.00
 * $Revision: 7 $
 * $Date: 14/05/06 11:27a $
 * @brief    NUC200 series PWM driver header file
 *
 * @note
...
/** @addtogroup NUC200_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup NUC200_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_PWM_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_PWM_Driver */
