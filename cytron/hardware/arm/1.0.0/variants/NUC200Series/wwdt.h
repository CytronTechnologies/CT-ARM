 ...
 * $Revision: 6 $
 * $Date: 14/05/09 3:22p $
 * @brief    NUC200 series WWDT driver header file
 *
 * @note
...
/** @addtogroup NUC200_WWDT_Driver WWDT Driver
  @{
*/

/** @addtogroup NUC200_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC200_WWDT_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_WWDT_EXPORTED_FUNCTIONS WWDT Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_WWDT_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_WWDT_Driver */
