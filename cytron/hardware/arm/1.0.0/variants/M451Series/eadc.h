...
#define EADC_FALLING_EDGE_TRIGGER           (EADC_SCTL_EXTREN_Msk | (1UL<<EADC_SCTL_TRGSEL_Pos))       /*!< STADC pin falling edge trigger */
#define EADC_RISING_EDGE_TRIGGER            (EADC_SCTL_EXTFEN_Msk | (1UL<<EADC_SCTL_TRGSEL_Pos))       /*!< STADC pin rising edge trigger */
...
#define EADC_CMP_ADCMPIE_ENABLE             (EADC_CMP_CMPWEN_Msk)    /*!< A/D result compare interrupt enable */
#define EADC_CMP_ADCMPIE_DISABLE            (~EADC_CMP_CMPWEN_Msk)   /*!< A/D result compare interrupt disable */

/*@}*/ /* end of group M451_EADC_EXPORTED_CONSTANTS */

/** @addtogroup M451_EADC_EXPORTED_FUNCTIONS EADC Exported Functions
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/**
  ...
  */
#define EADC_IS_SAMPLE_MODULE_OV(eadc) (((eadc)->STATUS & EADC_STATUS2_STOVF_Msk) >> EADC_STATUS2_STOVF_Pos)
...
/**
  ...
  */
#define EADC_IS_INT_FLAG_OV(eadc) (((eadc)->STATUS & EADC_STATUS2_ADOVIF_Msk) >> EADC_STATUS2_ADOVIF_Pos)
