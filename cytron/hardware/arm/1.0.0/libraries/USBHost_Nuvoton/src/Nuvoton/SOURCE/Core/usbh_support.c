...
#include "../../INCLUDE/usbh_hub.h"
#include "../../INCLUDE/usbh_ohci.h"
...
#else
static __attribute__((__aligned__(32))) ED_T  g_ed_pool[ED_MAX_NUM];
static __attribute__((__aligned__(32))) TD_T  g_td_pool[TD_MAX_NUM];
static __attribute__((__aligned__(32))) URB_T  g_urb_pool[URB_MAX_NUM];
#endif
