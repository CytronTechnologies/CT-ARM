...
/** @addtogroup M451_USBD_Driver USBD Driver
  @{
*/

/** @addtogroup M451_USBD_EXPORTED_STRUCTS USBD Exported Structs
  @{
*/
...
/*@}*/ /* end of group M451_USBD_EXPORTED_STRUCTS */




/** @addtogroup M451_USBD_EXPORTED_CONSTANTS USBD Exported Constants
  @{
*/
...
#define USBD_WAKEUP_EN          USBD_ATTR_WKIEN_Msk         /*!< USB Wake-up Enable */
#define USBD_DRVSE0             USBD_SE0_SE0_Msk         /*!< Drive SE0 */

#define USBD_DPPU_EN            USBD_ATTR_DPPUEN_Msk        /*!< USB D+ Pull-up Enable */
#define USBD_PWRDN              USBD_ATTR_PHYPWR_Msk         /*!< PHY Turn-On */
...
/*@}*/ /* end of group M451_USBD_EXPORTED_CONSTANTS */


/** @addtogroup M451_USBD_EXPORTED_FUNCTIONS USBD Exported Functions
  @{
*/
