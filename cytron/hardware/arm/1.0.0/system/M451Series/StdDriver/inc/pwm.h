...
/** @addtogroup M451_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*@}*/ /* end of group M451_PWM_EXPORTED_CONSTANTS */
 ...
 * \hideinitializer
 */
#define PWM_SET_CNR(pwm, u32ChannelNum, u32CNR)  (*(__IO uint32_t *) (&((pwm)->PERIOD0) + (u32ChannelNum)) = (u32CNR))
