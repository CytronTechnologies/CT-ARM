...
/** @addtogroup M451_EBI_Driver EBI Driver
  @{
*/

/** @addtogroup M451_EBI_EXPORTED_FUNCTIONS EBI Exported Functions
  @{
*/
...
/*@}*/ /* end of group M451_EBI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_EBI_Driver */
