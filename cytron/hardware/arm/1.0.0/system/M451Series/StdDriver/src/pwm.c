...
/** @addtogroup M451_PWM_Driver PWM Driver
  @{
*/


/** @addtogroup M451_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
 ...
 *                - PWM1 : PWM Group 1
 * @param[in] u32ChannelNum PWM channel number. Valid values are between 0~5
 * @param[in] u32SyncSrc PWM counter loading mode.
...
{
    (pwm)->SYNC = (((pwm)->SYNC & ~(PWM_SYNC_SINSRCn_Msk | PWM_SYNC_PHSDIRn_Msk)) | \
                   ((u32Direction << PWM_SYNC_PHSDIR0_Pos | u32SyncSrc << PWM_SYNC_SINSRC0_Pos) << (u32ChannelNum >> 1)));
    *(__IO uint32_t *)(&((pwm)->PHS0_1) + (u32ChannelNum >> 1)) = (*(__IO uint32_t *)(&((pwm)->PHS0_1) + (u32ChannelNum >> 1)) & ~PWM_PHS0_1_PHS_Msk) | u32StartPhase;
}
...
/*@}*/ /* end of group M451_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_PWM_Driver */
