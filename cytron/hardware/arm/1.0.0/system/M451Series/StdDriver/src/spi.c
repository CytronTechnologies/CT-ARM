...
/** @addtogroup M451_SPI_Driver SPI Driver
  @{
*/


/** @addtogroup M451_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/**
  ...
  *                     (SPI_UNIT_INT_MASK, SPI_SSACT_INT_MASK, SPI_SSINACT_INT_MASK, SPI_SLVUR_INT_MASK, SPI_SLVBE_INT_MASK, SPI_SLVTO_INT_MASK,
  *                     SPI_TXUF_INT_MASK, SPI_FIFO_TXTH_INT_MASK, SPI_FIFO_RXTH_INT_MASK, SPI_FIFO_RXOV_INT_MASK, SPI_FIFO_RXTO_INT_MASK)
  * @return None
...
/**
  ...
  *                     (SPI_UNIT_INT_MASK, SPI_SSACT_INT_MASK, SPI_SSINACT_INT_MASK, SPI_SLVUR_INT_MASK, SPI_SLVBE_INT_MASK,
  *                     SPI_SLVTO_INT_MASK, SPI_TXUF_INT_MASK, SPI_FIFO_RXOV_INT_MASK, SPI_FIFO_RXTO_INT_MASK)
  * @return None
...
/**
  ...
  *                     (SPI_BUSY_MASK, SPI_RX_EMPTY_MASK, SPI_RX_FULL_MASK, SPI_TX_EMPTY_MASK,
  *                     SPI_TX_FULL_MASK, SPI_TXRX_RESET_MASK, SPI_SPIEN_STS_MASK, SPI_SSLINE_STS_MASK)
...
/*@}*/ /* end of group M451_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_SPI_Driver */
