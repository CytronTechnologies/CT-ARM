 ...
 * @brief    NUC200 series CRC driver header file
 *
 * @note
...
/** @addtogroup NUC200_CRC_Driver CRC Driver
  @{
*/

/** @addtogroup NUC200_CRC_EXPORTED_CONSTANTS CRC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC200_CRC_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_CRC_EXPORTED_FUNCTIONS CRC Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_CRC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_CRC_Driver */
