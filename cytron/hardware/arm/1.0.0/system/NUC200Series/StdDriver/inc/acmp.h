 ...
 * $Revision: 7 $
 * $Date: 7/22/14 6:58p $
 * @brief    NUC200 series Analog Comparator (ACMP) driver header file
 *
 * @note
...
/** @addtogroup NUC200_ACMP_EXPORTED_CONSTANTS ACMP Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_ACMP_EXPORTED_CONSTANTS */
...
/**
  ...
  * @param[in] acmp The pointer of the specified ACMP module
  * @param[in] u32ChNum The ACMP number
  * @param[in] u32Src Comparator 0 negative input selection.  Including:
