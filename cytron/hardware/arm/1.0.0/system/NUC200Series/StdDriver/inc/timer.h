 ...
 * @version  V3.00
 * $Revision: 8 $
 * $Date: 14/07/30 10:59a $
 * @brief    NUC200 series Timer driver header file
 *
 * @note
...
/** @addtogroup NUC200_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup NUC200_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup NUC200_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_TIMER_Driver */
