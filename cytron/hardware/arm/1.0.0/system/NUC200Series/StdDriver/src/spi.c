 ...
 * $Revision: 8 $
 * $Date: 7/30/14 7:46p $
 * @brief    NUC200 series SPI driver source file
 *
 * @note
...
/** @addtogroup NUC200_SPI_Driver SPI Driver
  @{
*/


/** @addtogroup NUC200_SPI_EXPORTED_FUNCTIONS SPI Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC200_SPI_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_SPI_Driver */
