...
/** @addtogroup NUC131_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup NUC131_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group NUC131_ADC_EXPORTED_CONSTANTS */
...
/**
  ...
  * @note NUC131 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
...
/*@}*/ /* end of group NUC131_ADC_Driver */
