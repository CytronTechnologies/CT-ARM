...
/** @addtogroup M451_SCUART_EXPORTED_CONSTANTS SCUART Exported Constants
  @{
*/
#define SCUART_CHAR_LEN_5     (0x3ul << SC_UARTCTL_DATA_LEN_Pos)  /*!< Set SCUART word length to 5 bits */
#define SCUART_CHAR_LEN_6     (0x2ul << SC_UARTCTL_DATA_LEN_Pos)  /*!< Set SCUART word length to 6 bits */
#define SCUART_CHAR_LEN_7     (0x1ul << SC_UARTCTL_DATA_LEN_Pos)  /*!< Set SCUART word length to 7 bits */
...
#define SCUART_PARITY_ODD     (SC_UARTCTL_OPE_Msk | SC_UARTCTL_ PBOFF _Msk)   /*!< Set SCUART transfer with odd parity  */
#define SCUART_PARITY_EVEN    (SC_UARTCTL_OPE_Msk)                        /*!< Set SCUART transfer with even parity */
...
/*@}*/ /* end of group M451_SCUART_EXPORTED_CONSTANTS */
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_GET_RX_FULL(sc) ((sc)->STATUS & SC_STATUS_RXFULLF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define SCUART_IS_RX_FULL(sc) ((sc)->STATUS & SC_STATUS_RXFULLF_Msk ? 1 : 0)
