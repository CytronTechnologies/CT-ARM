...
/** @addtogroup M451_PDMA_Driver PDMA Driver
  @{
*/

/** @addtogroup M451_PDMA_EXPORTED_CONSTANTS PDMA Exported Constants
  @{
*/
...
/*@}*/ /* end of group M451_PDMA_EXPORTED_CONSTANTS */

/** @addtogroup M451_PDMA_EXPORTED_FUNCTIONS PDMA Exported Functions
  @{
*/
 ...
 */
#define PDMA_SET_TRANS_CNT(u32Ch, u32TransCount) ((uint32_t)(PDMA->DSCT[(u32Ch)].CTL=(PDMA->DSCT[(u32Ch)].CTL&~PDMA_DSCT_CTL_TXCNT_Msk)|((u32TransCount) << PDMA_DSCT_CTL_TXCNT_Pos)))
...
/*@}*/ /* end of group M451_PDMA_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_PDMA_Driver */
