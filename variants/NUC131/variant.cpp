...
const BoardToPin BoardToPinInfo[] = {
  ...
  {32, ADC_TYPE,  0},  // 14: PA.0  ADC_CH0   A0
  {33, ADC_TYPE,  1},  // 15: PA.1  ADC_CH1   A1
  {34, ADC_TYPE,  2},  // 16: PA.2  ADC_CH2   A2
  {35, ADC_TYPE,  3},  // 17: PA.3  ADC_CH3   A3
  {37, ADC_TYPE,  4},  // 18: PA.5  ADC_CH5   A4
  {38, ADC_TYPE,  5},  // 19: PA.6  ADC_CH6   A5

  {42, I2C_TYPE,  0},  // 20: PC.6  I2C0_SDA  I2C_SDA
  {41, I2C_TYPE,  0},  // 21: PC.7  I2C0_SCL  I2C_SCL

  {22, SPI_TYPE,  0},  // 22: PC.2  SPI0_MISO MISO
  {23, SPI_TYPE,  0},  // 23: PC.1  SPI0_CLK  SCK
  {21, SPI_TYPE,  0},  // 24: PC.3  SPI0_MOSI MOSI
  {24, SPI_TYPE,  0},  // 25: PC.0  SPI0_SS0  SS
...
SPIPinDescription SPI_Desc[] = {
  {SPI0, SPI0_MODULE, SPI0_IRQn, CLK_CLKSEL1_SPI0_S_PLL, {
