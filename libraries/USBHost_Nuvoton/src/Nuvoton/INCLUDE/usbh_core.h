...
} __attribute__((packed)) USB_DEV_DESC_T;                       /*!< device descriptor structure            */
...
}  __attribute__((packed)) USB_EP_DESC_T;                        /*!< Endpoint descriptor structure          */
...
} __attribute__((packed)) USB_IF_DESC_T;                        /*!< Interface descriptor structure         */
...
} __attribute__((packed)) USB_CONFIG_DESC_T;                    /*!< Configuration descriptor structure     */
...
/** @addtogroup M451_USBH_Driver USBH Driver
  @{
*/


/** @addtogroup M451_USBH_EXPORTED_FUNCTIONS USBH Exported Functions
  @{
*/
...
/*@}*/ /* end of group M451_USBH_CORE_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_USBH_CORE_Driver */
