 ...
 * $Revision: 30 $
 * $Date: 14/08/01 2:54p $
 * @brief    NUC200 series CLK driver source file
 *
 * @note
...
/** @addtogroup NUC200_CLK_Driver CLK Driver
  @{
*/

/** @addtogroup NUC200_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
{
    uint8_t u32FomSel; /* u32FomSel[1:0] => 72MHz, [3:2] => 50MHz, [5:4] => 25MHz */
    uint32_t u32Div;
...
/**
  ...
  * |\ref PWM01_MODULE   |\ref (CLK_CLKSEL1_PWM01_S_HXT |CLK_CLKSEL2_PWM01_EXT_HXT)     | x                      |
  * |\ref PWM01_MODULE   |\ref (CLK_CLKSEL1_PWM01_S_LXT |CLK_CLKSEL2_PWM01_EXT_LXT)     | x                      |
  * |\ref PWM01_MODULE   |\ref (CLK_CLKSEL1_PWM01_S_HCLK|CLK_CLKSEL2_PWM01_EXT_HCLK)    | x                      |
  * |\ref PWM01_MODULE   |\ref (CLK_CLKSEL1_PWM01_S_HIRC|CLK_CLKSEL2_PWM01_EXT_HIRC)    | x                      |
  * |\ref PWM01_MODULE   |\ref (CLK_CLKSEL1_PWM01_S_LIRC|CLK_CLKSEL2_PWM01_EXT_LIRC)    | x                      |
  * |\ref PWM23_MODULE   |\ref (CLK_CLKSEL1_PWM23_S_HXT |CLK_CLKSEL2_PWM23_EXT_HXT)     | x                      |
  * |\ref PWM23_MODULE   |\ref (CLK_CLKSEL1_PWM23_S_LXT |CLK_CLKSEL2_PWM23_EXT_LXT)     | x                      |
  * |\ref PWM23_MODULE   |\ref (CLK_CLKSEL1_PWM23_S_HCLK|CLK_CLKSEL2_PWM23_EXT_HCLK)    | x                      |
  * |\ref PWM23_MODULE   |\ref (CLK_CLKSEL1_PWM23_S_HIRC|CLK_CLKSEL2_PWM23_EXT_HIRC)    | x                      |
  * |\ref PWM23_MODULE   |\ref (CLK_CLKSEL1_PWM23_S_LIRC|CLK_CLKSEL2_PWM23_EXT_LIRC)    | x                      |
  ...
  * |\ref PWM45_MODULE   |\ref (CLK_CLKSEL2_PWM45_S_HXT |CLK_CLKSEL2_PWM45_EXT_HXT)     | x                      |
  * |\ref PWM45_MODULE   |\ref (CLK_CLKSEL2_PWM45_S_LXT |CLK_CLKSEL2_PWM45_EXT_LXT)     | x                      |
  * |\ref PWM45_MODULE   |\ref (CLK_CLKSEL2_PWM45_S_HCLK|CLK_CLKSEL2_PWM45_EXT_HCLK)    | x                      |
  * |\ref PWM45_MODULE   |\ref (CLK_CLKSEL2_PWM45_S_HIRC|CLK_CLKSEL2_PWM45_EXT_HIRC)    | x                      |
  * |\ref PWM45_MODULE   |\ref (CLK_CLKSEL2_PWM45_S_LIRC|CLK_CLKSEL2_PWM45_EXT_LIRC)    | x                      |
  * |\ref PWM67_MODULE   |\ref (CLK_CLKSEL2_PWM67_S_HXT |CLK_CLKSEL2_PWM67_EXT_HXT)     | x                      |
  * |\ref PWM67_MODULE   |\ref (CLK_CLKSEL2_PWM67_S_LXT |CLK_CLKSEL2_PWM67_EXT_LXT)     | x                      |
  * |\ref PWM67_MODULE   |\ref (CLK_CLKSEL2_PWM67_S_HCLK|CLK_CLKSEL2_PWM67_EXT_HCLK)    | x                      |
  * |\ref PWM67_MODULE   |\ref (CLK_CLKSEL2_PWM67_S_HIRC|CLK_CLKSEL2_PWM67_EXT_HIRC)    | x                      |
  * |\ref PWM67_MODULE   |\ref (CLK_CLKSEL2_PWM67_S_LIRC|CLK_CLKSEL2_PWM67_EXT_LIRC)    | x                      |                                 | x                      |
...
/*@}*/ /* end of group NUC200_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_CLK_Driver */
