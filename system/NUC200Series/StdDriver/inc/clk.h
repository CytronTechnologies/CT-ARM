 ...
 * @version  V3.0
 * $Revision: 27 $
 * $Date: 14/06/24 10:50a $
 * @brief    NUC200 Series Clock Control Driver Header File
 *
 * @note
...
/** @addtogroup NUC200_CLK_EXPORTED_CONSTANTS CLK Exported Constants
  @{
*/
...
#define CLK_PWRCON_LXT_EN       (0x01UL<<CLK_PWRCON_XTL32K_EN_Pos) /*!< Enable 32.768 kHz External Low Speed Crystal (LXT) */
...
/*@}*/ /* end of group NUC200_CLK_EXPORTED_CONSTANTS */
