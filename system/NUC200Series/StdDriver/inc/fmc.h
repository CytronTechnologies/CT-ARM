 ...
 * $Revision: 6 $
 * $Date: 14/05/05 1:50p $
 * @brief    NUC200 Series Flash Memory Controller Driver Header File
 *
 * @note
...
/** @addtogroup NUC200_FMC_Driver FMC Driver
  @{
*/

/** @addtogroup NUC200_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_FMC_EXPORTED_CONSTANTS */

/** @addtogroup NUC200_FMC_EXPORTED_FUNCTIONS FMC Exported Functions
  @{
*/
 ...
 *             This funciton is used to set BS bit of ISPCON to boot to APROM.
 *
 ...
 *             This funciton is used to clear BS bit of ISPCON to boot to LDROM.
 *
...
/**
  ...
  *
  * @details  This funciton is used to read device ID.
  *
  */
...
/**
  ...
  *
  * @details  This funciton is used to read product ID.
  *
  */
...
/**
  ...
  *
  * @details    This function is used to read uniquid chip ID (UCID).
  *
  */
...
/*@}*/ /* end of group NUC200_FMC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_FMC_Driver */
