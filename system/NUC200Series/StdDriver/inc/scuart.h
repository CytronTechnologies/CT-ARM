 ...
 * @brief    NUC200 series Smartcard UART mode (SCUART) driver header file
 *
 * @note
...
/** @addtogroup NUC200_SCUART_EXPORTED_CONSTANTS SCUART Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC200_SCUART_EXPORTED_CONSTANTS */
