...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    CLK->FRQDIV = CLK_FRQDIV_FDIV_EN_Msk | u32ClkDiv | u32ClkDivBy1En<<CLK_FRQDIV_DIV1_Pos;
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    int32_t i32NRVal;
    if ( u32PllFreq < FREQ_24MHZ)
        u32PllFreq=FREQ_24MHZ;
    else if(u32PllFreq > FREQ_128MHZ)
        u32PllFreq=FREQ_128MHZ;
