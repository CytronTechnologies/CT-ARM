                                  ...
                                  uint32_t u32DutyCycle)
{
    ...
    if(pwm == PWM0)
        u32ClkSrc = (CLK->CLKSEL1 & (CLK_CLKSEL1_PWM0_CH01_S_Msk << (u32ChannelNum >> 1))) >> (CLK_CLKSEL1_PWM0_CH01_S_Pos >> (u32ChannelNum >> 1));
    else
        u32ClkSrc = (CLK->CLKSEL2 & (CLK_CLKSEL2_PWM1_CH01_S_Msk << (u32ChannelNum >> 1))) >> (CLK_CLKSEL2_PWM1_CH01_S_Pos >> (u32ChannelNum >> 1));
