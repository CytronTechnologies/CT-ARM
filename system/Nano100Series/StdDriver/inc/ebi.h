...
/*  EBI access macros                                                                                      */
/*---------------------------------------------------------------------------------------------------------*/
#define EBI_READ_DATA8(Addr)            *((volatile unsigned char *)(EBI_BASE_ADDR+Addr))        /*!< Byte read       */
#define EBI_WRITE_DATA8(Addr, Data)     *((volatile unsigned char *)(EBI_BASE_ADDR+Addr))=Data   /*!< Byte write      */
#define EBI_READ_DATA16(Addr)           *((volatile unsigned short *)(EBI_BASE_ADDR+Addr))       /*!< Half-word read  */
#define EBI_WRITE_DATA16(Addr, Data)    *((volatile unsigned short *)(EBI_BASE_ADDR+Addr))=Data  /*!< Half-word write */
#define EBI_READ_DATA32(Addr)           *((volatile unsigned int *)(EBI_BASE_ADDR+Addr))         /*!< Word read       */
#define EBI_WRITE_DATA32(Addr, Data)    *((volatile unsigned int *)(EBI_BASE_ADDR+Addr))=Data    /*!< Word write      */
