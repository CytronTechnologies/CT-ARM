...
#define SYS_BODCTL_17EN         SYS_BODCTL_BOD17_EN_Msk          /*!<Detector 1.7V Function Enable */
#define SYS_BODCTL_20EN         SYS_BODCTL_BOD20_EN_Msk          /*!<Detector 2.0V Function Enable */
#define SYS_BODCTL_25EN         SYS_BODCTL_BOD25_EN_Msk          /*!<Detector 2.5V Function Enable */
#define SYS_BODCTL_17RSTEN      SYS_BODCTL_BOD17_RST_EN_Msk      /*!<1.7V Reset Enable */
#define SYS_BODCTL_20RSTEN      SYS_BODCTL_BOD20_RST_EN_Msk      /*!<2.0V Reset Enable */
#define SYS_BODCTL_25RSTEN      SYS_BODCTL_BOD25_RST_EN_Msk      /*!<2.5V Reset Enable */
#define SYS_BODCTL_17INTEN      SYS_BODCTL_BOD17_INT_EN_Msk      /*!<1.7V Interrupt Enable */
#define SYS_BODCTL_20INTEN      SYS_BODCTL_BOD20_INT_EN_Msk      /*!<2.0V Interrupt Enable */
#define SYS_BODCTL_25INTEN      SYS_BODCTL_BOD25_INT_EN_Msk      /*!<2.5V Interrupt Enable */

/********************* Bit definition of VREFCTL register **********************/
#define SYS_VREFCTL_BGP_EN      SYS_Int_VREFCTL_BGP_EN_Msk       /*!<Band-gap Enable */
#define SYS_VREFCTL_REG_EN      SYS_Int_VREFCTL_REG_EN_Msk       /*!<Regulator Enable */
#define SYS_VREFCTL_SEL25       SYS_Int_VREFCTL_SEL25_Msk        /*!<Regulator Output Voltage 2.5V */
#define SYS_VREFCTL_EXTMODE     SYS_Int_VREFCTL_EXT_MODE_Msk     /*!<Regulator External Mode */

/********************* Bit definition of IRCTRIMCTL register **********************/
#define SYS_IRCTRIMCTL_SEL_MASK       SYS_IRCTRIMCTL_TRIM_SEL_Msk              /*!<Trim frequency selection mask */
#define SYS_IRCTRIMCTL_TRIM_DISABLE  (0x0UL<<SYS_IRCTRIMCTL_TRIM_SEL_Pos)      /*!<Disable auto-trim function */
...
#define SYS_IRCTRIMCTL_LOOP_MASK     (0x3UL<<SYS_IRCTRIMCTL_TRIM_LOOP_Pos)     /*!<Trim calculation loop mask */
...
#define SYS_IRCTRIMCTL_RETRY_COUNT  (0x3UL<<SYS_IRCTRIMCTL_TRIM_RETRY_CNT_Pos) /*!<Trim value update limitation count mask */
...
#define SYS_IRCTRIMINT_32KERR_ENNT  SYS_IRCTRIMINT_32K_ERR_INT_Msk        /*!<32.768 kHz Clock Error Interrupt Status */
...
#define SYS_PA_L_MFP_PA7_MFP_LCD_S18      (7UL<<SYS_PA_L_MFP_PA7_MFP_Pos)     /*!<PA7 Pin Function - LCD SEG 18 */
...
#define SYS_PA_L_MFP_PA0_MFP_MASK         (7UL<<SYS_PA_L_MFP_PA0_MFP_Pos)     /*!<PA0 Pin Function Mask */
...
#define SYS_PB_H_MFP_PB11_MFP_LCD_V3      (7UL<<SYS_PB_H_MFP_PB11_MFP_Pos)        /*!<PB11 Pin Function - LCD V3 */
...
#define SYS_PB_H_MFP_PB9_MFP_LCD_V1       (7UL<<SYS_PB_H_MFP_PB9_MFP_Pos)     /*!<PB9 Pin Function - LCD V1 */
...
#define SYS_PB_H_MFP_PB_H_MFP__PB8_MFP_SC2_PWR        (4UL<<SYS_PB_H_MFP_PB8_MFP_Pos)     /*!<PB8 Pin Function - SmartCard 2 power */
#define SYS_PB_H_MFP_PB_H_MFP__PB8_MFP_LCD_S30        (7UL<<SYS_PB_H_MFP_PB8_MFP_Pos)     /*!<PB8 Pin Function - LCD SEG 30 */
...
#define SYS_IS_SYSTEM_RST()             (SYS->RST_SRC & SYS_RST_SRC_RSTS_SYS_Msk)      /*!< This macro get previous reset source is from system reset */
