...
/** @addtogroup M451_CLK_Driver CLK Driver
  @{
*/

/** @addtogroup M451_CLK_EXPORTED_FUNCTIONS CLK Exported Functions
  @{
*/
...
/**
  ...
  *             enable clock divider output function and set configuration.
...
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
    ...
    i32TimeOutCnt = SystemCoreClock / 30; /* About 300ms */
...
/*@}*/ /* end of group M451_CLK_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_CLK_Driver */
