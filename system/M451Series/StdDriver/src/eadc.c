...
/**
  ...
  *                            - \ref EADC_FALLING_EDGE_TRIGGER       : STEADC pin falling edge trigger
  *                            - \ref EADC_RISING_EDGE_TRIGGER        : STEADC pin rising edge trigger
...
void EADC_ConfigSampleModule(EADC_T *eadc, \
                             ...
                             uint32_t u32Channel)
{
    eadc->SCTL[u32ModuleNum] &= ~(EADC_SCTL_TRGSEL_Msk | EADC_SCTL_CHSEL_Msk);
                              ...
                              uint32_t u32DelayClockDivider)
{
    ...
    eadc->SCTL[u32ModuleNum] |= (u32TriggerDelayTime | u32DelayClockDivider);
}
...
void EADC_SetExtendSampleTime(EADC_T *eadc, uint32_t u32ModuleNum, uint32_t u32ExtendSampleTime)
{
    ...
    eadc->SCTL[u32ModuleNum] |= u32ExtendSampleTime;
