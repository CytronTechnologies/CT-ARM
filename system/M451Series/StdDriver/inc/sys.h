...
/** @addtogroup M451_SYS_Driver SYS Driver
  @{
*/

/** @addtogroup M451_SYS_EXPORTED_CONSTANTS SYS Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
#define CHIP_RST    ((0x0<<24) | SYS_IPRST0_CHIPRST_Pos )   /*!< Reset CHIP */
#define CPU_RST     ((0x0<<24) | SYS_IPRST0_CPURST_Pos )    /*!< Reset CPU */
...
#define SYS_GPD_MFPL_PD4MFP_PWM0_BREAK0     (5ul << SYS_GPD_MFPL_PD4MFP_Pos)        /*!< GPD_MFPL PD4 setting for PWM0_BREAK0*/
...
#define SYS_GPD_MFPL_PD5MFP_PWM0_BREAK1     (5ul << SYS_GPD_MFPL_PD5MFP_Pos)        /*!< GPD_MFPL PD5 setting for PWM0_BREAK1*/
...
/*@}*/ /* end of group M451_SYS_EXPORTED_CONSTANTS */


/** @addtogroup M451_SYS_EXPORTED_FUNCTIONS SYS Exported Functions
  @{
*/
...
/*@}*/ /* end of group M451_SYS_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M451_SYS_Driver */
