...
/** @addtogroup M451_SC_EXPORTED_CONSTANTS SC Exported Constants
  @{
*/
#define SC_INTERFACE_NUM        1                /*!< Smartcard interface numbers */
...
/*@}*/ /* end of group M451_SC_EXPORTED_CONSTANTS */
